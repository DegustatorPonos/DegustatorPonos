## Hello. My name is Physick.

I am a student (the information might become outdated by now) and am working as a software engineer. Current directions: embedded Linux and web-development.  
...
- Golang - The language I tried by accident and it felt good. The current pet project I surely will finish is written in it and it's my current language of choice if I need to build something fast.
